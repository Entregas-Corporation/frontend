...
class UserSuspenedListview extends StatefulWidget {
  const UserSuspenedListview({super.key});

  @override
  State<UserSuspenedListview> createState() => _UserSuspenedListviewState();
}

class _UserSuspenedListviewState extends State<UserSuspenedListview> {
                ...
                itemBuilder: (_, index) {
                  ...
                  if (userPageDto[index].role != "ADMIN") {
                    return ItemUserHorizontal(
                      model: model,
                      onPressed: () {
                        userController.reactived(model.id);
                      },
                      icon: const Icon(
                        Icons.autorenew,
                        color: LightColors.success,
                      ),
                      tooltipText: TextConstant.reactivate,
                    );
                  }
