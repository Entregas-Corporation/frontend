...
mixin _$ProductCategoryController on ProductCategoryControllerBase, Store {
  ...
  late final _$productCatgoryItemAtom = Atom(
      name: 'ProductCategoryControllerBase.productCatgoryItem',
      context: context);

  @override
  String? get productCatgoryItem {
    _$productCatgoryItemAtom.reportRead();
    return super.productCatgoryItem;
  }

  @override
  set productCatgoryItem(String? value) {
    _$productCatgoryItemAtom.reportWrite(value, super.productCatgoryItem, () {
      super.productCatgoryItem = value;
    });
  }
  ...
  String toString() {
    return '''
productCatgoryItem: ${productCatgoryItem},
