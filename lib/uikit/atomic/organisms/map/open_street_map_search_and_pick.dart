...
class OpenStreetMapSearchAndPick extends StatefulWidget {
  ...
  const OpenStreetMapSearchAndPick({
    ...
    this.buttonColor = const Color(0xffFE0000),
    this.locationPinIconColor = const Color(0xffFE0000),
    this.locationPinText = 'Local',
    this.locationPinTextStyle = const TextStyle(
        fontSize: 14,
        fontFamily: 'Martel Sans',
        fontWeight: FontWeight.w500,
        color: const Color(0xffFE0000)),
    this.hintText = 'Procurar Local',
    ...
    this.buttonText = 'Selecionar Local',
...
class _OpenStreetMapSearchAndPickState
  ...
  Widget build(BuildContext context) {
    ...
    OutlineInputBorder inputBorder = OutlineInputBorder(
      borderSide: BorderSide(color: const Color(0XFFF4F5F6), width: 2.0),
      borderRadius: BorderRadius.all(
        Radius.circular(8),
      ),
    );
    OutlineInputBorder inputFocusBorder = OutlineInputBorder(
      borderSide: BorderSide(color: const Color(0xFF000000), width: 2.0),
      borderRadius: BorderRadius.all(
        Radius.circular(8),
      ),
    );
  ...
  Future<PickedData> pickData() async {
    ...
    return PickedData(center, displayName, address, city);
  }
}
...
class PickedData {
  ...
  PickedData(this.latLong, this.addressName, this.address, this.city);
}
